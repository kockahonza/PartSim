...
template <typename T> class LabeledParticle : public Particle {
  private:
    T m_label;

  public:
    LabeledParticle(T label, double mass = 1, Eigen::Vector3d position = {0, 0, 0},
                    Eigen::Vector3d velocity = {0, 0, 0}, Eigen::Vector3d force = {0, 0, 0})
